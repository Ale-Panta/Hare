...
namespace Hare
{
	...
	void ImGuiLayer::SetDarkThemeColor()
	{
		...
		colors[ImGuiCol_TabHovered] = ImVec4(0.38f, 0.3885f, 0.381f, 1.0f);
		colors[ImGuiCol_TabActive] = ImVec4(0.28f, 0.2885f, 0.281f, 1.0f);
		...
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.95f, 0.1585f, 0.951f, 1.0f);
	}

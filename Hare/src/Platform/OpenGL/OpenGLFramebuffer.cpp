...
namespace Hare
{
	...
	namespace Utils
	{
		...
		static GLenum HareFBTextureFormatToGL(FramebufferTextureFormat format)
		{
			switch (format)
			{
	...
	{
		HR_CORE_ASSERT(attachmentIndex < m_ColorAttachments.size());
	...
	void OpenGLFramebuffer::ClearAttachment(uint32_t attachmentIndex, int value)
	{
		...
		glClearTexImage(m_ColorAttachments[attachmentIndex], 0,
			Utils::HareFBTextureFormatToGL(spec.TextureFormat), GL_INT, &value);
	}
}